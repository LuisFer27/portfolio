  ...
  public static function setPage($id, $name, $rr, $url, $btns = '')
  {
    ...
    $ht = '<div class="btn-group" role="group" >
        <div class="btn-group" role="group">
          <button id="btnGroupDrop' . $id . '" type="button" class="btn btn-sm btn-white dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ' . $name . '
          </button>
